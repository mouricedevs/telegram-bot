...
module.exports = {
    ...
    onStart: async function ({ bot, chatId, args }) {
        if (args.length === 0) {
            return bot.sendMessage(chatId, "Please provide tiktok URL. Usage: .insta <url>");
        }
        ...
        try {
            ...
            if (giftDevs) {
                ...
                bot.sendMessage(chatId, "Please provide instagram video link for download. Usage: .insta <url>");
            }
        } catch (error) {
